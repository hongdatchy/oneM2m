...
public class Router implements CseService {
	...
	public ResponsePrimitive doRequest(RequestPrimitive request) {
		...
		try {
			...
			// Lấy ra CSE-ID tại substring đầu tiên /CSE-ID/Cái gì tính sau/
			...
			// Redirection case
			/*
			 * Khi CSE-ID lấy được ở trên không khớp với CSE-ID hiện tại của node
			 * */
			...
			// hieuttbk Không có RETRIEVE case ?
