...
//				Map<String, DataMapperService> map =  DataMapperSelector.getDataMapperList();
//			
//				for (Map.Entry<String, DataMapperService> entry : map.entrySet()) {
//		            System.out.println("\n----->hieuttbk" + entry.getKey() + " " + entry.getValue());
//		        } 
